...
class _AddTransactionScreenState extends State<AddTransactionScreen> {
  ...
  final List<Map<String, dynamic>> _transactionTypes = [
    ...
    {'type': TransactionType.payment, 'label': 'Payment', 'icon': Icons.payment},
  ];
    ...
    try {
      ...
      if (mounted) {
        setState(() {
          ...
          if (widget.accountId != null && _accounts.any((a) => a.id == widget.accountId)) {
                ...
                itemBuilder: (context, index) {
                  ...
                  return Card(
                    ...
                    shape: RoundedRectangleBorder(
                      ...
                      side: isSelected
                          ? BorderSide(color: AppColors.primary.withAlpha(26), width: 1.5) // ~10% opacity
                        ...
                        child: Row(
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                color: isSelected 
                                    ? AppColors.primary.withAlpha(26) // ~10% opacity
                                ...
                                children: [
                                  ...
                                  Text(
                                    ...
                                    style: textTheme.bodySmall?.copyWith(
                                      color: isSelected 
                                          ? AppColors.primary.withAlpha(204) // ~80% opacity
                                          : AppColors.textSecondary,
                                    ),
                                  ),
                                ],
          ...
          : SingleChildScrollView(
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    // Transaction Type
                    Text('Transaction Type', style: textTheme.titleMedium?.copyWith(fontWeight: FontWeight.w600)),
                    ...
                    Wrap(
                      ...
                      children: _transactionTypes.map((type) {
                        ...
                        return FilterChip(
                          ...
                          onSelected: (selected) {
                            if (selected) {
                              setState(() => _selectedType = type['type'] as TransactionType);
                            }
                          },
                          avatar: Icon(type['icon'] as IconData, color: isSelected ? _getTransactionTypeColor(_selectedType) : null),
                          backgroundColor: Colors.grey[200],
                          selectedColor: _getTransactionTypeColor(type['type'] as TransactionType).withAlpha(51), // ~20% opacity
                          labelStyle: TextStyle(
                            color: isSelected ? _getTransactionTypeColor(_selectedType) : AppColors.textPrimary,
                    ...
                    TextFormField(
                      ...
                      style: textTheme.bodyLarge?.copyWith(fontSize: 16, fontWeight: FontWeight.w500),
                    ...
                    if (_selectedType == TransactionType.transfer) ...[
                      ...
                      TextFormField(
                        ...
                        validator: (value) => (value?.isEmpty ?? true) && _selectedType == TransactionType.transfer 
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          ...
                          disabledBackgroundColor: AppColors.primary.withAlpha(128), // ~50% opacity
                        ),
                        child: _isSubmitting
                            ? const SizedBox(
                                width: 24,
